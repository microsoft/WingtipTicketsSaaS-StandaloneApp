...
$ResourceGroupName = "wingtip-sa-bgx" # the resource group used when the Wingtip SaaS application was deployed. CASE SENSITIVE
$User              = "bgx"         # the User value entered when the Wingtip SaaS application was deployed
