[CmdletBinding()]
Param(
    # Resource group containing the catalog 
...
# DTU burst level is randomized between tenants by applying a factor with min and max values 
$burstMinFactor = 0.7
$burstMaxFactor = 1.1
    ...
    $scriptBlock = `
        {
            ...
            While ([DateTime]::Now -lt $endTime)
            {
                ...
                # configure and submit the SQL script to generate the load
